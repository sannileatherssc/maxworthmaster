...
@Component({
  selector: 'app-mobilecomputers',
  templateUrl: './mobilecomputers.component.html',
  styleUrls: ['./mobilecomputers.component.css']
})
export class MobilecomputersComponent implements OnInit {

...
import { WirelessproductComponent } from './Components/wirelessproduct/wirelessproduct.component';
import { RfidproductComponent } from './Components/rfidproduct/rfidproduct.component';
...
import { BarcodescannerproductComponent } from './Components/barcodescannerproduct/barcodescannerproduct.component';
import { AviationprinterproductComponent } from './Components/aviationprinterproduct/aviationprinterproduct.component';
import { AirradioproductComponent } from './Components/airradioproduct/airradioproduct.component';
import { BarcodescannerproducttypeComponent } from './Components/barcodescannerproducttype/barcodescannerproducttype.component';
...
@NgModule({
  declarations: [
    ...
    WirelessComponent,
    CartComponent,
    AviationsectorComponent,
    EgovernancesectorComponent,
    FriendlymobilesectorComponent,
    HealthcaresectorComponent,
    HospitalitysectorComponent,
    ManufacturingsectorComponent,
    RetailsectorComponent,
    TelcomsectorComponent,
    CheckoutComponent,
    FormsComponent,
    TopnavbarComponent,
    ConnectComponent,
    ...
    SucessfullComponent,
    SolutionsComponent,
    WirelessproductComponent,
    RfidproductComponent,
    PrintersproductComponent,
    MobilecomputersproductComponent,
    DocumentreaderproductComponent,
    BarcodescannerproductComponent,
    AviationprinterproductComponent,
    AirradioproductComponent,
    BarcodescannerproducttypeComponent,
    MobilecomputersproducttypeComponent,
    BarcodeprinterproducttypeComponent,
    AviationprinterproducttypeComponent,
    DocumentreaderproducttypeComponent,
    BarcodeprinterproductComponent,
    CareerComponent,
    ClientlistComponent,
